        ...
        <div className="relative px-5 py-6 md:px-10 md:py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
            <div className="flex flex-col items-center gap-4 text-center w-full">
              {icon && (
                <div className="flex-shrink-0 animate-float mb-2">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-totoro-blue/70 text-[10px] font-bold uppercase tracking-[0.2em] font-sans max-w-[280px] mx-auto leading-relaxed">
                  {subtitle}
                </p>
              </div>
            </div>
