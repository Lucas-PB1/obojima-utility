...
export default function SimpleIngredientCard({ 
  ...
  const getBadgeClass = () => {
    if (ingredient.combat === maxAttr) return 'bg-gradient-to-br from-totoro-orange/10 to-totoro-orange/20 border-totoro-orange/20';
    if (ingredient.utility === maxAttr) return 'bg-gradient-to-br from-totoro-blue/10 to-totoro-blue/20 border-totoro-blue/20';
    return 'bg-gradient-to-br from-totoro-yellow/10 to-totoro-yellow/20 border-totoro-yellow/20';
  };

  return (
    <div className={`group bg-white/95 p-5 rounded-2xl border border-white shadow-sm transition-all duration-500 hover:shadow-xl hover:-translate-y-2 relative overflow-hidden ${className} ${getBadgeClass()}`}>
      <div className="relative z-10">
        ...
        <div className="flex justify-center items-center gap-1.5 pt-2 border-t border-black/5">
          <div className="flex flex-col items-center bg-white/80 px-2 py-1 rounded-lg border border-totoro-orange/10 min-w-[32px] font-sans">
            ...
            <span className="text-xs font-bold text-totoro-orange font-mono">{ingredient.combat}</span>
          </div>
          <div className="flex flex-col items-center bg-white/80 px-2 py-1 rounded-lg border border-totoro-blue/10 min-w-[32px] font-sans">
            ...
            <span className="text-xs font-bold text-totoro-blue font-mono">{ingredient.utility}</span>
          </div>
          <div className="flex flex-col items-center bg-white/80 px-2 py-1 rounded-lg border border-totoro-yellow/10 min-w-[32px] font-sans">
            ...
            <span className="text-xs font-bold text-totoro-yellow font-mono">{ingredient.whimsy}</span>
          </div>
        </div>
      </div>
