  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 space-y-4">
        ...
        <div
          className={`inline-block px-2 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider backdrop-blur-md shadow-[inset_0_0_0_1px_rgba(255,255,255,0.16)] ${
        ...
        <div className="grid grid-cols-3 gap-3 py-3 shadow-[inset_0_1px_0_var(--hairline),inset_0_-1px_0_var(--hairline)]">
