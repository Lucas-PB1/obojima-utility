                          ...
                          <button
                            onClick={() => {
                              const newName = prompt(
                                t('admin.modal.actions.edit_name'),
                                user.displayName || ''
                              );
                              if (newName && newName !== user.displayName)
                                onUpdate(user.uid, { displayName: newName });
                            }}
                            ...
                            <select
                              ...
                              onChange={(e) => {
                                if (confirm(t('admin.modal.actions.change_role', e.target.value))) {
                                  onUpdate(user.uid, { role: e.target.value as 'user' | 'admin' });
                                }
                              }}
                            ...
                            >
                              ...
                              <div className="col-span-2 flex items-center justify-end gap-1">
                                ...
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleDeleteIngredient(item.id, localized.nome);
                                  }}
                          ...
                          >
                            ...
                            <div className="flex items-center gap-4 ml-4">
                              ...
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  handleDeletePotion(potion.id, potion.recipe.resultingPotion.nome);
                                }}
