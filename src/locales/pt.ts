export const pt = {
  ...
  'settings.account.profile.upload.title': 'Upload de imagem',
  'settings.account.profile.upload.description': 'PNG, JPG, GIF ou WebP até 2 MB.',
  'settings.account.profile.upload.choose': 'Escolher imagem',
  'settings.account.profile.upload.save': 'Enviar e salvar',
  'settings.account.profile.upload.validation.type': 'Escolha um arquivo de imagem válido.',
  'settings.account.profile.upload.validation.size': 'A imagem precisa ter no máximo 2 MB.',
  'settings.account.profile.upload.feedback.saved': 'Imagem enviada e perfil atualizado.',
  'settings.account.profile.upload.feedback.error': 'Não foi possível enviar a imagem agora.',
  ...
  'settings.account.providers.title': 'Contas vinculadas',
  'settings.account.providers.google.heading': 'Google',
  'settings.account.providers.google.description':
    'Use sua conta Google para entrar sem perder este perfil e seus dados salvos.',
  'settings.account.providers.google.status.linked': 'Vinculado',
  'settings.account.providers.google.status.notLinked': 'Não vinculado',
  ...
  'settings.account.providers.google.feedback.linked': 'Conta Google vinculada com sucesso.',
  'settings.account.providers.google.feedback.alreadyLinked': 'Sua conta Google já está vinculada.',
  'settings.account.providers.google.feedback.error':
    'Não foi possível vincular sua conta Google agora.',
  ...
  'settings.player.defaults.forage.title': 'Forrageio padrão',
  'settings.player.defaults.forage.description':
    'Defina região, tipo de teste e modificador que entram automaticamente no formulário.',
  'settings.player.defaults.modifier.label': 'Modificador',
  'settings.player.defaults.bonus.title': 'Bônus de rolagem',
  'settings.player.defaults.bonus.description':
    'Escolha um dado bônus opcional e a quantidade usada por padrão.',
  ...
  'auth.google.error': 'Erro ao autenticar com Google.',
  'auth.reset.forgot': 'Esqueci a senha',
  'auth.reset.emailRequired': 'Informe seu email para receber o link de redefinição.',
  'auth.reset.sent':
    'Enviamos um email com o link para redefinir sua senha. Verifique sua caixa de entrada.',
  'auth.reset.error': 'Não foi possível enviar o email de redefinição agora.',
  'auth.validation.passwordMismatch': 'As senhas não coincidem',
  'auth.validation.passwordMinLength': 'A senha deve ter pelo menos 6 caracteres',
  ...
  'social.tabs.chats': 'Conversas',
  'social.tabs.search': 'Buscar',
  'social.tabs.requests': 'Solicitações',
  'social.tabs.notifications': 'Notificações',
  ...
  'social.chats.empty': 'Nenhuma conversa ainda. Abra um chat pela lista de amigos.',
  'social.chats.noMessages': 'Sem mensagens ainda',
  'social.requests.empty': 'Nenhuma solicitação pendente',
  'social.requests.sent': 'Enviadas',
  'social.requests.sentEmpty': 'Você não tem solicitações enviadas pendentes.',
  'social.requests.cancel': 'Cancelar solicitação',
  ...
  'social.friends.block': 'Bloquear usuário',
  'social.friends.report': 'Denunciar',
  'social.friends.blockTitle': 'Bloquear usuário',
  'social.friends.blockConfirm':
    'Bloquear {name}? Vocês deixarão de ser amigos e não poderão interagir.',
  'social.friends.reportTitle': 'Denunciar usuário',
  'social.friends.reportDescription': 'Conte o que aconteceu com {name}.',
  'social.friends.reportDetails': 'Detalhes opcionais',
  'social.report.reason.spam': 'Spam',
  'social.report.reason.abuse': 'Abuso',
  'social.report.reason.harassment': 'Assédio',
  'social.report.reason.trade': 'Problema em troca',
  'social.report.reason.other': 'Outro',
  'social.notifications.title': 'Notificações',
  'social.notifications.markAllRead': 'Marcar lidas',
  'social.notifications.empty': 'Nada novo por aqui.',
